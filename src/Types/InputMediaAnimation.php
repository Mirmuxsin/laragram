...
* InputMediaAnimation
 *
 *<p>*Optional*. Pass *True* if the animation needs to be covered with a spoiler animation</p>
 *
...
{
    /**
    * <p>Type of the result, must be *animation*</p>
    * @var string
    */
    public string $type;
    ...
    */
    ...
    /**
    * <p>*Optional*. Caption of the animation to be sent, 0-1024 characters after entities parsing</p>
    * @var string|null
    */
    public ?string $caption = null;

    /**
    * <p>*Optional*. Mode for parsing entities in the animation caption. See <a href="https://core.telegram.org/bots/api/#formatting-options">formatting options</a> for more details.</p>
    * @var string|null
    */
    ...
    */
    ...
    /**
    * <p>*Optional*. Animation height</p>
    * @var int|null
    */
    public ?int $height = null;

    /**
    * <p>*Optional*. Animation duration in seconds</p>
    * @var int|null
    */
