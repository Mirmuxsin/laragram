...
Please note that this parameter doesn't affect updates created before the call to the setWebhook, so unwanted updates may be received for a short period of time.
    ...
    public static function forwardMessage (int|string $chat_id, int|string $from_chat_id, $disable_notification, $protect_content, $message_id, ) {
    ...
    public static function sendPhoto (int|string $chat_id, \Milly\Laragram\Types\InputFile|string $photo, $caption, $parse_mode, $caption_entities, $disable_notification, $protect_content, $reply_to_message_id, $allow_sending_without_reply, \Milly\Laragram\Types\InlineKeyboardMarkup|\Milly\Laragram\Types\ReplyKeyboardMarkup|\Milly\Laragram\Types\ReplyKeyboardRemove|\Milly\Laragram\Types\ForceReply $reply_markup, ) {
    ...
    public static function sendAudio (int|string $chat_id, \Milly\Laragram\Types\InputFile|string $audio, $caption, $parse_mode, $caption_entities, $duration, $performer, $title, \Milly\Laragram\Types\InputFile|string $thumb, $disable_notification, $protect_content, $reply_to_message_id, $allow_sending_without_reply, \Milly\Laragram\Types\InlineKeyboardMarkup|\Milly\Laragram\Types\ReplyKeyboardMarkup|\Milly\Laragram\Types\ReplyKeyboardRemove|\Milly\Laragram\Types\ForceReply $reply_markup, ) {
    ...
    public static function sendDocument (int|string $chat_id, \Milly\Laragram\Types\InputFile|string $document, \Milly\Laragram\Types\InputFile|string $thumb, $caption, $parse_mode, $caption_entities, $disable_content_type_detection, $disable_notification, $protect_content, $reply_to_message_id, $allow_sending_without_reply, \Milly\Laragram\Types\InlineKeyboardMarkup|\Milly\Laragram\Types\ReplyKeyboardMarkup|\Milly\Laragram\Types\ReplyKeyboardRemove|\Milly\Laragram\Types\ForceReply $reply_markup, ) {
    ...
    public static function sendVideo (int|string $chat_id, \Milly\Laragram\Types\InputFile|string $video, $duration, $width, $height, \Milly\Laragram\Types\InputFile|string $thumb, $caption, $parse_mode, $caption_entities, $supports_streaming, $disable_notification, $protect_content, $reply_to_message_id, $allow_sending_without_reply, \Milly\Laragram\Types\InlineKeyboardMarkup|\Milly\Laragram\Types\ReplyKeyboardMarkup|\Milly\Laragram\Types\ReplyKeyboardRemove|\Milly\Laragram\Types\ForceReply $reply_markup, ) {
    ...
    public static function sendAnimation (int|string $chat_id, \Milly\Laragram\Types\InputFile|string $animation, $duration, $width, $height, \Milly\Laragram\Types\InputFile|string $thumb, $caption, $parse_mode, $caption_entities, $disable_notification, $protect_content, $reply_to_message_id, $allow_sending_without_reply, \Milly\Laragram\Types\InlineKeyboardMarkup|\Milly\Laragram\Types\ReplyKeyboardMarkup|\Milly\Laragram\Types\ReplyKeyboardRemove|\Milly\Laragram\Types\ForceReply $reply_markup, ) {
    ...
    public static function sendVoice (int|string $chat_id, \Milly\Laragram\Types\InputFile|string $voice, $caption, $parse_mode, $caption_entities, $duration, $disable_notification, $protect_content, $reply_to_message_id, $allow_sending_without_reply, \Milly\Laragram\Types\InlineKeyboardMarkup|\Milly\Laragram\Types\ReplyKeyboardMarkup|\Milly\Laragram\Types\ReplyKeyboardRemove|\Milly\Laragram\Types\ForceReply $reply_markup, ) {
    ...
    public static function sendVideoNote (int|string $chat_id, \Milly\Laragram\Types\InputFile|string $video_note, $duration, $length, \Milly\Laragram\Types\InputFile|string $thumb, $disable_notification, $protect_content, $reply_to_message_id, $allow_sending_without_reply, \Milly\Laragram\Types\InlineKeyboardMarkup|\Milly\Laragram\Types\ReplyKeyboardMarkup|\Milly\Laragram\Types\ReplyKeyboardRemove|\Milly\Laragram\Types\ForceReply $reply_markup, ) {
    ...
    public static function sendMediaGroup (int|string $chat_id, $media, $disable_notification, $protect_content, $reply_to_message_id, $allow_sending_without_reply, ) {
    ...
    public static function sendLocation (int|string $chat_id, $latitude, $longitude, $horizontal_accuracy, $live_period, $heading, $proximity_alert_radius, $disable_notification, $protect_content, $reply_to_message_id, $allow_sending_without_reply, \Milly\Laragram\Types\InlineKeyboardMarkup|\Milly\Laragram\Types\ReplyKeyboardMarkup|\Milly\Laragram\Types\ReplyKeyboardRemove|\Milly\Laragram\Types\ForceReply $reply_markup, ) {
    ...
    public static function sendVenue (int|string $chat_id, $latitude, $longitude, $title, $address, $foursquare_id, $foursquare_type, $google_place_id, $google_place_type, $disable_notification, $protect_content, $reply_to_message_id, $allow_sending_without_reply, \Milly\Laragram\Types\InlineKeyboardMarkup|\Milly\Laragram\Types\ReplyKeyboardMarkup|\Milly\Laragram\Types\ReplyKeyboardRemove|\Milly\Laragram\Types\ForceReply $reply_markup, ) {
    ...
    public static function sendContact (int|string $chat_id, $phone_number, $first_name, $last_name, $vcard, $disable_notification, $protect_content, $reply_to_message_id, $allow_sending_without_reply, \Milly\Laragram\Types\InlineKeyboardMarkup|\Milly\Laragram\Types\ReplyKeyboardMarkup|\Milly\Laragram\Types\ReplyKeyboardRemove|\Milly\Laragram\Types\ForceReply $reply_markup, ) {
    ...
    public static function sendDice (int|string $chat_id, $emoji, $disable_notification, $protect_content, $reply_to_message_id, $allow_sending_without_reply, \Milly\Laragram\Types\InlineKeyboardMarkup|\Milly\Laragram\Types\ReplyKeyboardMarkup|\Milly\Laragram\Types\ReplyKeyboardRemove|\Milly\Laragram\Types\ForceReply $reply_markup, ) {
    ...
    public static function sendChatAction (int|string $chat_id, $action, ) {
    ...
    public static function restrictChatMember (int|string $chat_id, $user_id, $permissions, $until_date, ) {
    ...
    public static function promoteChatMember (int|string $chat_id, $user_id, $is_anonymous, $can_manage_chat, $can_post_messages, $can_edit_messages, $can_delete_messages, $can_manage_video_chats, $can_restrict_members, $can_promote_members, $can_change_info, $can_invite_users, $can_pin_messages, ) {
    ...
    public static function setChatPermissions (int|string $chat_id, $permissions, ) {
...
Otherwise, you may use links like `t.me/your_bot?start=XXXX` that open your bot with a parameter.
    ...
    public static function deleteMessage (int|string $chat_id, $message_id, ) {
     ...
     /**
     * @var int|string  chat_id *(required: true)* Unique identifier for the target chat or username of the target channel (in the format `@channelusername`)
     * @var \Milly\Laragram\Types\InputFile|string  sticker *(required: true)* Sticker to send. Pass a file\_id as String to send a file that exists on the Telegram servers (recommended), pass an HTTP URL as a String for Telegram to get a .WEBP file from the Internet, or upload a new one using multipart/form-data. [More information on Sending Files »](https://core.telegram.org/bots/api/#sending-files)
     * @var bool disable_notification  Sends the message [silently](https://telegram.org/blog/channels-2-0#silent-messages). Users will receive a notification with no sound.
     * @var bool protect_content  Protects the contents of the sent message from forwarding and saving
     * @var integer reply_to_message_id  If the message is a reply, ID of the original message
     * @var bool allow_sending_without_reply  Pass *True*, if the message should be sent even if the specified replied-to message is not found
    ...
    public static function sendSticker (int|string $chat_id, \Milly\Laragram\Types\InputFile|string $sticker, $disable_notification, $protect_content, $reply_to_message_id, $allow_sending_without_reply, \Milly\Laragram\Types\InlineKeyboardMarkup|\Milly\Laragram\Types\ReplyKeyboardMarkup|\Milly\Laragram\Types\ReplyKeyboardRemove|\Milly\Laragram\Types\ForceReply $reply_markup, ) {
    ...
    public static function uploadStickerFile ($user_id, $png_sticker, ) {
    ...
    public static function createNewStickerSet ($user_id, $name, $title, \Milly\Laragram\Types\InputFile|string $png_sticker, $tgs_sticker, $webm_sticker, $emojis, $contains_masks, $mask_position, ) {
    ...
    public static function addStickerToSet ($user_id, $name, \Milly\Laragram\Types\InputFile|string $png_sticker, $tgs_sticker, $webm_sticker, $emojis, $mask_position, ) {
    ...
    public static function setStickerSetThumb ($name, $user_id, \Milly\Laragram\Types\InputFile|string $thumb, ) {
        return Laragram::request('setStickerSetThumb', func_get_args());
    }
...
*Example:* An inline bot that sends YouTube videos can ask the user to connect the bot to their YouTube account to adapt search results accordingly. To do this, it displays a 'Connect your YouTube account' button above the results, or even before showing any. The user presses the button, switches to a private chat with the bot and, in doing so, passes a start parameter that instructs the bot to return an OAuth link. Once done, the bot can offer a [*switch\_inline*](https://core.telegram.org/bots/api/#inlinekeyboardmarkup) button so that the user can easily return to the chat where they wanted to use the bot's inline capabilities.
    ...
    public static function sendInvoice (int|string $chat_id, $title, $description, $payload, $provider_token, $currency, $prices, $max_tip_amount, $suggested_tip_amounts, $start_parameter, $provider_data, $photo_url, $photo_size, $photo_width, $photo_height, $need_name, $need_phone_number, $need_email, $need_shipping_address, $send_phone_number_to_provider, $send_email_to_provider, $is_flexible, $disable_notification, $protect_content, $reply_to_message_id, $allow_sending_without_reply, $reply_markup, ) {
    ...
    public static function sendGame ($chat_id, $game_short_name, $disable_notification, $protect_content, $reply_to_message_id, $allow_sending_without_reply, $reply_markup, ) {
